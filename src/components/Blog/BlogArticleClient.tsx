        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
          ...
          <aside className="lg:col-span-3">
            <div className="sticky top-28 space-y-6">
              <div className="rounded-[24px] border border-[#b8d8ca] bg-[#dcece7] p-6 shadow-[0_12px_36px_rgba(22,134,95,0.08)] backdrop-blur-md">
                <div className="flex items-center gap-2 border-b border-[#b8d8ca] pb-4">
                  <div className="h-2 w-2 rounded-full bg-[#16865f] animate-pulse" />
                  <h3 className="text-xs font-bold uppercase tracking-widest text-[#176b50]">
                    Table of Contents
                  </h3>
                </div>
                      ...
                      return (
                        <a
                          ...
                          className={`group flex items-start gap-3 rounded-xl px-3.5 py-2.5 text-sm font-medium transition-all ${isActive
                            ? "bg-[#16865f] font-semibold text-white shadow-md shadow-emerald-700/20"
                            : "text-[#3f665b] hover:bg-white/55 hover:text-[#176b50]"
                            }`}
                        >
                          <span
